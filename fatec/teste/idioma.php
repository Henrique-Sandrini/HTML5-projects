	...
	<div class="row row-cols-lg-8 row-cols-sm-6 g-4">
		<div class="col">
			<div class="card border-dark">
				...
				<div class="card-body text-center">
					<p class="card-text"><a href="idiomaSeleciona.php?idioma=pt_BR"><img src="./icones/pt_BR.png"
								width="100px"></a></p>
				</div>
		...
		<div class="col">
			<div class="card border-dark">
				...
				<div class="card-body text-center">
					<p class="card-text"><a href="idiomaSeleciona.php?idioma=en_US"><img src="./icones/en_US.png"
								width="100px"></a></p>
				</div>
				<div class="card-footer border-dark text-center">
		...
		<div class="col">
			<div class="card border-dark">
				...
				<div class="card-body text-center">
					<p class="card-text"><a href="idiomaSeleciona.php?idioma=es_CO"><img src="./icones/es_CO.png"
								width="100px"></a></p>
				</div>
				<div class="card-footer border-dark text-center">
		...
		<div class="col">
			<div class="card border-dark">
				...
				<div class="card-body text-center">
					<p class="card-text"><a href="idiomaSeleciona.php?idioma=es_MX"><img src="./icones/es_MX.png"
								width="100px"></a></p>
				</div>
				<div class="card-footer border-dark text-center">
		...
		<div class="col">
			<div class="card border-dark">
				...
				<div class="card-body text-center">
					<p class="card-text"><a href="idiomaSeleciona.php?idioma=es_ES"><img src="./icones/es_ES.png"
								width="100px"></a></p>
				</div>
				<div class="card-footer border-dark text-center">
		...
		<div class="col">
			<div class="card border-dark">
				...
				<div class="card-body text-center">
					<p class="card-text"><a href="idiomaSeleciona.php?idioma=es_AR"><img src="./icones/es_AR.png"
								width="100px"></a></p>
				</div>
				<div class="card-footer border-dark text-center">
		...
		<div class="col">
			<div class="card border-dark">
				...
				<div class="card-body text-center">
					<p class="card-text"><a href="idiomaSeleciona.php?idioma=en_UK"><img src="./icones/en_UK.png"
								width="100px"></a></p>
				</div>
				<div class="card-footer border-dark text-center">
		...
		<div class="col">
			<div class="card border-dark">
				...
				<div class="card-body text-center">
					<p class="card-text"><a href="idiomaSeleciona.php?idioma=fr_FR"><img src="./icones/fr_FR.png"
								width="100px"></a></p>
				</div>
				<div class="card-footer border-dark text-center">
		...
		<div class="col">
			<div class="card border-dark">
				...
				<div class="card-body text-center">
					<p class="card-text"><a href="idiomaSeleciona.php?idioma=it_IT"><img src="./icones/it_IT.png"
								width="100px"></a></p>
				</div>
				<div class="card-footer border-dark text-center">
		...
		<div class="col">
			<div class="card border-dark">
				...
				<div class="card-body text-center">
					<p class="card-text"><a href="idiomaSeleciona.php?idioma=de_DE"><img src="./icones/de_DE.png"
								width="100px"></a></p>
				</div>
				<div class="card-footer border-dark text-center">
